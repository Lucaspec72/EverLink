/*
  ...
  What it does:
    ...
    - Every ~250ms, prints a summary line for live debugging via Host's Device Console
...
void printSummary() {
  ...
  // whoever happens to be watching the Device Console with that caveat in mind.
